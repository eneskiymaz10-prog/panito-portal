          ...
          <Table>
            ...
            <TableBody>
              {((order as any).order_items || []).map((item: any) => {
                const calc = item.products ? calculateFromMasterboxes(item.quantity_masterboxes, item.products.masterboxes_per_pallet, item.products.units_per_masterbox) : null;
                return (
